...
! function(t, e) {
    ...
    var ht = {
            ...
            return r(e, [{
                ...
                value: function() {
                    var t = this.art.option,
                        e = t.theme,
                        r = t.backdrop;
                    this.$container.innerHTML = '<div class="art-undercover"></div><div class="art-video-player art-subtitle-show art-layer-show" style="--theme: '.concat(e, '"><video class="art-video"></video><div class="art-subtitle"></div><div class="art-danmuku"></div><div class="art-layers"></div><div class="art-mask"><div class="art-state"></div></div><div class="art-bottom"><div class="art-progress"></div><div class="art-controls"><div class="art-controls-left"></div><div class="art-controls-right"></div></div></div><div class="art-loading"></div><div class="art-notice"><div class="art-notice-inner"></div></div><div class="art-settings"><div class="art-setting-inner"><div class="art-setting-body"></div></div></div><div class="art-info"><div class="art-info-panel"><div class="art-info-item"><div class="art-info-title">Ro-Player v2</div></div><div class="art-info-item"><div class="art-info-title">Volume:</div><div class="art-info-content" data-video="volume"></div></div><div class="art-info-item"><div class="art-info-title">Tempo atual:</div><div class="art-info-content" data-video="currentTime"></div></div><div class="art-info-item"><div class="art-info-title">Duração:</div><div class="art-info-content" data-video="duration"></div></div><div class="art-info-item"><div class="art-info-title">Resolução:</div><div class="art-info-content"><span data-video="videoWidth"></span> x <span data-video="videoHeight"></span></div></div></div><div class="art-info-item"><div class="art-info-title">Enfim, apenas para nerds mesmo ¯\_(ツ)_/¯</div></div></div><div class="art-info-close">[Fechar]</div></div><div class="art-mini-header"><div class="art-mini-title"></div><div class="art-mini-close">xD7</div></div><div class="art-contextmenus"></div></div>'), this.$undercover = this.query(".art-undercover"), this.$player = this.query(".art-video-player"), this.$video = this.query(".art-video"), this.$subtitle = this.query(".art-subtitle"), this.$danmuku = this.query(".art-danmuku"), this.$bottom = this.query(".art-bottom"), this.$progress = this.query(".art-progress"), this.$controls = this.query(".art-controls"), this.$controlsLeft = this.query(".art-controls-left"), this.$controlsRight = this.query(".art-controls-right"), this.$layer = this.query(".art-layers"), this.$loading = this.query(".art-loading"), this.$notice = this.query(".art-notice"), this.$noticeInner = this.query(".art-notice-inner"), this.$mask = this.query(".art-mask"), this.$state = this.query(".art-state"), this.$setting = this.query(".art-settings"), this.$settingInner = this.query(".art-setting-inner"), this.$settingBody = this.query(".art-setting-body"), this.$info = this.query(".art-info"), this.$infoPanel = this.query(".art-info-panel"), this.$infoClose = this.query(".art-info-close"), this.$miniHeader = this.query(".art-mini-header"), this.$miniTitle = this.query(".art-mini-title"), this.$miniClose = this.query(".art-mini-close"), this.$contextmenu = this.query(".art-contextmenus"), r && (g(this.$settingInner, "art-backdrop-filter"), g(this.$info, "art-backdrop-filter"), g(this.$contextmenu, "art-backdrop-filter")), this.art.isMobile && g(this.$container, "art-mobile")
                }
            }, {
                key: "mobile",
                value: function() {
        ...
        pt = {
            "Video info": "Informações",
            Close: "Fechar",
            "Light Off": "Apagar Luz",
            "Light On": "Ligar Luz",
            "Video load failed": "O video falhou ao carregar",
            Volume: "Volume",
            Play: "Tocar",
            Pause: "Pausar",
            Rate: "Velocidade",
            ...
            "Hide subtitle": "Esconder legenda",
            "Show subtitle": "Mostrar legenda",
            "Hide danmu": "ESconder danmu",
            "Show danmu": "Mostrar danmu",
            "Show setting": "Mostrar configurações",
            "Hide setting": "Esconder configurações",
            Screenshot: "Print",
            ...
            Normal: "Normal",
            Open: "Abrir",
            "Switch video": "Trocar Video",
            "Switch subtitle": "Trocar Legenda",
            Fullscreen: "Tela cheia",
            "Exit fullscreen": "Sair da tela cheia",
            "Web fullscreen": "Tela do navegador cheia",
            "Exit web fullscreen": "Diminuir tela do navegador cheia",
            "Mini player": "Mini player",
            "PIP mode": "Modo picture-in-picture",
            "Exit PIP mode": "Sair do modo picture-in-picture",
            ...
            "Subtitle offset time": "Diferença de legenda e video",
            "No subtitles found": "Legenda não encontrada"
        },
        xt = function() {
            function e(r) {
        ...
        function n(e) {
            ...
            return o.$parent = l, e.once("ready", (function() {
                o.add(function(t) {
                    ...
                    return de(de({}, t), {}, {
                        html: '<a href="https://artplayer.org" target="_blank">Player</a>'
                    })
                }({
                    disable: !0,
                    name: "version",
    ...
    return console.log("%c Player", "color: #ff0; background: #5f5f5f", "color: #ff0; background: #4bc729", ""), nr
}));
